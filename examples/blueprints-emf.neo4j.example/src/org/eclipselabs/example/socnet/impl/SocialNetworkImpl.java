 ...
 * <ul>
 *   <li>{@link org.eclipselabs.example.socnet.impl.SocialNetworkImpl#getPersons <em>Persons</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SocialNetworkImpl extends EObjectImpl implements SocialNetwork {
	/**
	...
	protected EClass eStaticClass() {
		return SocnetPackage.Literals.SOCIAL_NETWORK;
	}
	...
	public EList<Person> getPersons() {
		if (persons == null) {
			persons = new EObjectContainmentEList<Person>(Person.class, this, SocnetPackage.SOCIAL_NETWORK__PERSONS);
		}
		return persons;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SocnetPackage.SOCIAL_NETWORK__PERSONS:
